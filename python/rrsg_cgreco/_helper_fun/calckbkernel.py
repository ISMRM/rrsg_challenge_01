...
def calculate_keiser_bessel_kernel(kwidth, overgridfactor, G, klength=32):
    """
    Function calculates the appropriate Kaiser-Bessel kernel for gridding, using the approach of Jackson et al.
    ...
    Returns:
        kern: kernel values for klength values of u, uniformly spaced from 0 to kwidth/2.
        kern_ft: ...
        kbu: u values.
    ...
    a = overgridfactor
    w = kwidth
    # From Beatty et al. - Rapid Gridding Reconstruction With a MinimalOversampling Ratio - equation [5]
